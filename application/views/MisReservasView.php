								...
								<tbody>
									...
									<tr align="center">	
										...
										<td style="white-space: nowrap;" >
											<button class="btn btn-sm btn-danger" type="button" onclick='window.location.href="<?=base_url("index.php/MisReservasController/mod/$fila->id_reserva")?>";'  >
											<em class="glyphicon glyphicon-chevron-right"></em> Anular Reserva
											</button>
										</td>
									</tr>
										<?php   
